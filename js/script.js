...
function mostrarProductos() {
    ...
    // Agregar eventos de "click" a las descripciones para alternar entre corta y larga
    ...
    // Agregar eventos click al botón "Añadir al carrito"
...
// Función para mostrar el contenido del carrito en formato de tabla
...
function eliminarUnidad(index) {
    ...
    if (carrito[index].cantidad > 1) {
        carrito[index].cantidad -= 1; // Reducir la cantidad del producto
    } else {
